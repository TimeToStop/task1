...
void ServerSocket::init(int port)
{
    ...
    if(_listener < 0)
    {
        throw ServerSocketException("Failed to create a listener socket");
    }
    ...
    {
        throw ServerSocketException("Failed to bind listener to address");
    }
...
std::string ServerSocket::read()
{
    ...
    if(socket < 0)
    {
        throw ServerSocketException("Failed to accept socket connection");
    }
